...
const storage = multer.diskStorage({
    destination: function (req, file, cb) {
        // console.log(file);
        const dir = '../assets/uploads/brands';
...
const brandStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        console.log(file);
        const dir = '../assets/uploads/service/book';
        mkdirp(dir, err => cb(err, dir));
    },
    filename: (req, file, cb) => {
        cb(null, Date.now() + path.extname(file.originalname));
...
const trendStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        // console.log(file);
        const dir = '../assets/uploads/trends';
        mkdirp(dir, err => cb(err, dir));
        // cb(null, dir);
    },
    filename: (req, file, cb) => {
...
const serviceRequestStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        // console.log(file);
        const dir = '../assets/uploads/request';
        mkdirp(dir, err => cb(err, dir));
        // cb(null, dir);
    },
    filename: (req, file, cb) => {
...
const staffStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        // console.log(file);
        const dir = '../assets/uploads/staff';
        mkdirp(dir, err => cb(err, dir));
        // cb(null, dir);
    },
    filename: (req, file, cb) => {
...
const bannerStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        // console.log(file);
        const dir = '../assets/uploads/banner';
        mkdirp(dir, err => cb(err, dir));
        // cb(null, dir);
    },
    filename: (req, file, cb) => {
...
const companyStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        // console.log(file);
        const dir = '../assets/uploads/company';
        mkdirp(dir, err => cb(err, dir));
        // cb(null, dir);
    },
    filename: (req, file, cb) => {
