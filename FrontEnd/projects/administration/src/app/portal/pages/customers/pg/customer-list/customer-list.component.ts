...
export class CustomerListComponent implements OnInit, AfterViewInit {
  ...
  elements: any = [];
  headElements = ['id', 'Name', 'Email', 'Contact', 'Date of registration', 'Address', 'Action',  'Status', 'Action'];
  ...
  constructor(private router:Router, private cdRef: ChangeDetectorRef, private GlobalService:GlobalService, private baseApp : AppComponent, private windowTitle:CustomersComponent) {
    windowTitle.title="Customer List"
  }
